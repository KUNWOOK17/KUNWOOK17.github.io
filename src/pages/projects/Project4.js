  ...
  return (
    <article className="proj4">
      <header className="proj4__hero">
        ...
        <h1 className="proj4__title">Industrial Safety Robot System: A Comprehensive Multi-Modal Approach </h1>
      ...
      <section className="proj4__section">
        ...
        <ul className="proj4__tags">
          <li>ROS2</li><li>OpenCV</li><li>YOLO</li><li>TurtleBot</li>
        </ul>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>Industrial safety remains a persistent challenge despite technological advancement. Statistical analysis from the Ministry of Employment and Labor (2024) reveals critical gaps in safety monitoring and enforcement.</p>
      ...
      <section className="proj4__section">
        ...
        <p>
          We define the instantaneous risk level <InlineMath math={"R(t)"} /> at time{" "}
          <InlineMath math={"t"} /> as:
        </p>

        {/* 중앙 블록 수식 */}
        <BlockMath math={"R(t) = \\sum_{i=1}^{n} P_i(t) \\cdot S_i \\cdot E_i(t)"} />

        <p>Where:</p>
        <ul>
          <li>
            <InlineMath math={"P_i(t)"} /> = Time-dependent probability of incident
            type <InlineMath math={"i"} />
          </li>
          <li>
        ...
        <p>
          ...
          <InlineMath math={"\\min \\int_0^T R(t) \\, dt \\quad \\text{subject to} \\quad \\sum_{j=1}^m C_j \\leq B"} />
        </p>
        ...
        <table className="proj4__table">
          ...
          <tbody>
            <tr>
              ...
              <td><InlineMath math={"V(t) = V_0 e^{-\\lambda t}"} /></td>
              <td>Continuous monitoring</td>
            </tr>
            <tr>
              <td>Cultural Pressure</td>
              <td><InlineMath math={"P_{speed} > P_{safety}"} /></td>
              <td>Automated enforcement</td>
            </tr>
            <tr>
              <td>Monitoring Gaps</td>
              <td><InlineMath math={"\\eta_{monitoring} < \\eta_{required}"} /></td>
              <td>Real-time surveillance</td>
            </tr>
            <tr>
              <td>Communication Barriers</td>
              <td><InlineMath math={"I_{effective} = I_{transmitted} \\cdot \\alpha"} /></td>
      ...
      <section className="proj4__section">
        <div className="proj4__card">
          ...
          <p>
          accident causes with behavioral factors highlighted
          </p>
        </div>
      </section>
      ...
      <section className="proj4__section">
        ...
        <table className="proj4__table">
          ...
          <tbody>
            ...
            <tr>
              <td><strong>State Estimation</strong></td>
              <td>Extended Kalman Filter</td>
              <td>Gaussian noise assumption validity</td>
            </tr>
            <tr>
              <td><strong>Coordinate Transform</strong></td>
              <td>TF2 Framework</td>
      ...
      <section className="proj4__section">
        ...
        />
        <p className="proj4__subtitle">
          Figure 5: Human Detect Architecture
        </p>
        <img
        ...
        />
        <p className="proj4__subtitle">
          Figure 6: Crack Detect Architecture
        </p>
        <img
      ...
      <section className="proj4__section">
        ...
        <p>
          For a distributed system with <InlineMath math={"n"} /> robots, system reliability{" "}
          <InlineMath math={"R_{system}"} /> is:
        </p>
        ...
        <p>
          With individual robot reliability <InlineMath math={"R_i = 0.95"} />, the system reliability for{" "}
          <InlineMath math={"n = 4"} /> robots:
        </p>
      ...
      <section className="proj4__section">
        <h2 className="proj4__h2">3. Human Detection & PPE Monitoring System</h2>
        {/* <hr className="proj4__divider" /> */}

        {/* 3.1 */}
        <hr className="proj4__divider" />
        <h2 className="proj4__h2">3.1 Dataset Preparation &amp; Model Selection</h2>
        <p className="proj4__lead">Dataset Specifications:</p>
        <ul className="proj4__bullets">
          <li><strong>Total Samples:</strong> 5,026 (Training: 4,401, Validation: 415, Test: 210)</li>
          <li><strong>Classes:</strong> Helmet, Safety Vest, Human, Safety Boots</li>
          <li><strong>Format:</strong> YOLO annotation format</li>
          <li><strong>Resolution:</strong> 640×640 pixels</li>
          <li><strong>Augmentation:</strong> Rotation (±15°), Scaling (0.8–1.2), Brightness (±20%)</li>
        </ul>
        <hr className="proj4__divider" />
        {/* 3.2 */}
        <h2 className="proj4__h2">3.2 Model Performance Analysis</h2>
        <p>Comparative analysis across YOLO variants using inference time distribution:</p>
        ...
        />
        <p className="proj4__subtitle">
          Figure 9: Box plots showing inference time distribution across different YOLO models
        </p>
        <p>Selection Rationale: YOLOv8n demonstrates optimal balance of accuracy, speed, and consistency for real-time industrial deployment.</p>
      </section>

      <section className="proj4__section">
        <h2 className="proj4__h2">3.3 Mathematical Framework for Detection</h2>

        <p><strong>Spatial Detection Universe:</strong>&nbsp;
          <InlineMath math={"\\mathcal{U} = \\{(x,y)\\mid 0 \\le x \\le W,\\ 0 \\le y \\le H\\}"} />
        </p>

        <p><strong>Detection Confidence Mapping:</strong></p>
        ...
        <p>
          Where <InlineMath math={"\\phi(x,y)"} /> represents feature extraction at pixel
          <InlineMath math={"\\ (x,y)"} /> and <InlineMath math={"\\sigma"} /> is the sigmoid activation.
        </p>

        <p><strong>PPE Compliance Assessment:</strong>&nbsp;
        ...
        />
        <p className="proj4__subtitle">
          Figure 6: Crack Detect Architecture (Visual representation of detection confidence mapping and PPE scoring system)
        </p>
      </section>


      <section className="proj4__section">
        <h2 className="proj4__h2">3.4 Noise Analysis &amp; Kalman Filter Design</h2>

        <p>
          <strong>Sensor Noise Characterization:</strong> Statistical analysis of OAK-D depth measurements reveals:
        </p>
        <ul className="proj4__bullets">
          <li>Standard Deviation: <InlineMath math={"\\sigma = 0.4261\\,\\text{m}"} /></li>
          <li>Variance: <InlineMath math={"\\sigma^2 = 0.1815\\,\\text{m}^2"} /></li>
          <li>Temporal Correlation: <InlineMath math={"\\rho(\\tau) = 0.85 e^{-\\tau/2.3}"} /></li>
        </ul>

        <p><strong>State Space Model Design:</strong></p>
        <p>For tracking human position and velocity, we employ a 4D state vector:</p>
        <BlockMath math={"\\mathbf{x}_k = [x_k, y_k, \\dot{x}_k, \\dot{y}_k]^T"} />

        <p><strong>Prediction Equations:</strong></p>
        <BlockMath math={"\\mathbf{x}_{k|k-1} = \\mathbf{F} \\mathbf{x}_{k-1|k-1} + \\mathbf{B}u_k"} />
        <BlockMath math={"\\mathbf{P}_{k|k-1} = \\mathbf{F} \\mathbf{P}_{k-1|k-1} \\mathbf{F}^T + \\mathbf{Q}"} />

        <p><strong>Update Equations:</strong></p>
        <BlockMath math={"\\mathbf{K}_k = \\mathbf{P}_{k|k-1}\\mathbf{H}^T (\\mathbf{H}\\mathbf{P}_{k|k-1}\\mathbf{H}^T + \\mathbf{R})^{-1}"} />
        <BlockMath math={"\\mathbf{x}_{k|k} = \\mathbf{x}_{k|k-1} + \\mathbf{K}_k(z_k - \\mathbf{H}\\mathbf{x}_{k|k-1})"} />
        ...
        {/* ----------------- 추가된 부분 ----------------- */}
        <p><strong>Theoretical Performance Advantage:</strong></p>
        <p>
          Comparing 2D vs 4D models, the Mean Squared Error difference:
        </p>
        <BlockMath math={"MSE_{2D} - MSE_{4D} = (\\dot{x}_{k-1})^2 (\\Delta t)^2 \\geq 0"} />
        <p>
        ...
        <p><strong>Overall Noise Reduction: 24.7%</strong></p>
      </section>
      ...
      <section className="proj4__section">
        <h2 className="proj4__h2">4. Crack Detection & Structural Analysis System</h2>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          The crack detection system employs a hybrid approach combining deep learning
          and classical computer vision:
        </p>

        <ol className="proj4__ol">
          <li>
            <strong>YOLO-based Region Proposal:</strong> Initial crack candidate identification
          </li>
          <li>
            <strong>HSV Color Space Segmentation:</strong> Precise crack boundary delineation
          </li>
          <li>
            <strong>Depth-Aware Area Calculation:</strong> 3D surface area estimation
          </li>
          <li>
            <strong>Global Coordinate Mapping:</strong> Integration with navigation system
          </li>
        </ol>
      </section>
      ...
      <section className="proj4__section">
        ...
        <ul className="proj4__bullets">
          <li>
            <strong>Illumination Invariance:</strong> Separates color information from lighting conditions
          </li>
          <li>
            <strong>Computational Efficiency:</strong> Linear complexity <InlineMath math={"O(n)"} /> for pixel processing
          </li>
          <li>
            <strong>Threshold Interpretability:</strong> Intuitive parameter tuning for industrial deployment
          </li>
          <li>
            <strong>Robustness:</strong> Effective performance with limited training data
          </li>
        </ul>
        ...
        />
        <p className="proj4__subtitle">
          Figure 10: HSV color space segmentation results showing crack isolation from background
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          <strong>Camera Calibration Model:</strong> Using OAK-D intrinsic parameters, the pixel-to-metric conversion:
        </p>
        <p>
          <InlineMath math={"\\mathrm{ratio}_x = \\dfrac{Z}{f_x},\\quad \\mathrm{ratio}_y = \\dfrac{Z}{f_y}"} />
        </p>

        <p><strong>Surface Area Estimation:</strong></p>
        <BlockMath math={String.raw`
          A_{\mathrm{crack}}
        ...
        <p>
          Where <InlineMath math={"\\theta_{i,j}"} /> represents the surface normal angle at pixel{" "}
          <InlineMath math={"(i, j)"} />.
        </p>

        <p><strong>Error Propagation Analysis:</strong></p>
        <BlockMath math={String.raw`
          \sigma_A^{2}
      ...
      <section className="proj4__section">
        <h2 className="proj4__h2">5. Autonomous Navigation & Multi-Robot Coordination</h2>
      </section>
      ...
      <section className="proj4__section">
        ...
        />
        <p className="proj4__subtitle">
          Figure 7: Navigation System Architecture (Navigation system state machine showing event handling hierarchy)
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p><strong>Priority Assignment Function:</strong></p>
        <BlockMath math={String.raw`
        ...
        <p>Where:</p>
        <ul className="proj4__bullets">
          <li><InlineMath math={`U(e_i)`} /> = Urgency level of event <InlineMath math={`i`} /></li>
          <li><InlineMath math={`T(e_i)`} /> = Time since event detection</li>
          <li><InlineMath math={`D(e_i)`} /> = Distance to event location</li>
          <li>
        ...
        <p>
          Where <InlineMath math={`x_{ij} \\in \\{0,1\\}`} /> indicates assignment of robot
      ...
      <section className="proj4__section">
        ...
        <p><strong>Buffer Size Optimization Problem:</strong></p>
        <p>
          Original configuration caused navigation failures in constrained environments.
        ...
        <ul className="proj4__bullets">
          <li><InlineMath math={`b_{min} \\leq b \\leq b_{max}`} /></li>
          <li><InlineMath math={`P_{collision}(b) \\leq P_{threshold}`} /></li>
          <li><InlineMath math={`T_{response}(b) \\leq T_{max}`} /></li>
        </ul>

        <p>
          <strong>Solution:</strong> Reduced inflation radius from 0.4m to 0.1m, resulting in:
        </p>
        <ul className="proj4__bullets">
      ...
      <section className="proj4__section">
        ...
        <p><strong>Reliability Comparison for Industrial Networks:</strong></p>

        <p>
          For a network with <InlineMath math={"n"} /> segments, failure probability analysis:
        </p>

        {/* ROS2 DDS (mesh) */}
        <p>
          <strong>ROS2 DDS (Mesh Topology):</strong>{" "}
          <InlineMath math={"P_{\\mathrm{DDS}\\_\\mathrm{failure}} = 1 - \\prod_{i=1}^{n} P_{\\mathrm{segment}_i}"} />
        </p>

        {/* MQTT (star) */}
        <p>
          <strong>MQTT (Star Topology):</strong>{" "}
          <InlineMath math={"P_{\\mathrm{MQTT}\\_\\mathrm{success}} = \\prod_{i=1}^{n} P_{\\mathrm{device\\to broker}}"} />
        </p>

        <p>
          Since devices connect independently:{" "}
          <InlineMath math={"P_{\\mathrm{MQTT}\\_\\mathrm{success}} \\gg P_{\\mathrm{DDS}\\_\\mathrm{success}}"} />
        </p>
        <img
          src={`${process.env.PUBLIC_URL}/images/MQTT_protocol.png`}
          alt="메인 아키텍처 다이어그램"
        ...
        />
        <p className="proj4__subtitle">
          Figure 8: MQTT protocol (Network topology comparison showing MQTT’s resilience advantages)
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p><strong>Protocol Efficiency Comparison:</strong></p>
        ...
        <p><strong>Message Overhead Analysis:</strong></p>
        ...
        <BlockMath math={"\\text{Efficiency Ratio} = \\frac{\\eta_{MQTT}}{\\eta_{HTTP}} \\approx 3 - 8"} />
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          <strong>Optimal Operating Point:</strong> Based on performance analysis, 10 fps provides
          optimal balance of reliability and real-time performance for industrial monitoring applications.
        </p>
      </section>

      <section className="proj4__section">
        <h2 className="proj4__h2">7. System Integration & Experimental Validation</h2>
      </section>
      ...
      <section className="proj4__section">
        ...
        <BlockMath math={"T_{total} = T_{detection} + T_{processing} + T_{communication} + T_{response}"} />

        <p>Measured components:</p>
        <ul className="proj4__bullets">
          <li><InlineMath math={"T_{detection} = 52 \\pm 8 \\, ms"} /> (YOLOv8n inference)</li>
          <li><InlineMath math={"T_{processing} = 23 \\pm 5 \\, ms"} /> (coordinate transformation)</li>
          <li><InlineMath math={"T_{communication} = 95 \\pm 15 \\, ms"} /> (MQTT round-trip)</li>
          <li><InlineMath math={"T_{response} = 180 \\pm 30 \\, ms"} /> (navigation initiation)</li>
        </ul>

        <p><strong>Total System Response Time:</strong> 350 ± 35 ms</p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          ...
          <InlineMath math={"Balance\\ Index = 1 - \\frac{\\sigma_{workload}}{\\mu_{workload}} = 0.89"} />
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        />
        <p className="proj4__subtitle">
          Figure 11: Web-based dashboard interface showing real-time monitoring and control features
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        />
        <p className="proj4__subtitle">
          Figure 12: Mobile application interface showing emergency response and notification features
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <hr className="proj4__divider" /> 
        {/* 9.1 */}
        <h2 className="proj4__h2">9.1 Coordinate System Calibration Challenge</h2>

        <p>
          <strong>Problem Statement:</strong> Systematic offset between detected object coordinates and actual global map positions, with average error of 0.35m.
        </p>

        <p className="proj4__lead">Root Cause Analysis:</p>
        <ol className="proj4__listnum">
          <li>
            <strong>Sensor Calibration Drift:</strong> OAK-D intrinsic parameters variation over time
          </li>
          <li>
            <strong>Accumulated Transformation Error:</strong> TF tree propagation inaccuracies
          </li>
          <li>
            <strong>Environmental Interference:</strong> Reflective surfaces affecting depth estimation
          </li>
        </ol>

        <p className="proj4__lead">Mathematical Error Model:</p>
        <BlockMath math={"\\mathbf{p}_{measured} = \\mathbf{R} \\mathbf{p}_{actual} + \\mathbf{t} + \\epsilon_{systematic} + \\eta_{noise}"} />
        <p>Where <InlineMath math={"\\mathbf{R}"} /> and <InlineMath math={"\\mathbf{t}"} /> represent systematic rotation and translation errors.</p>

        <p className="proj4__lead">Solution Implementation:</p>
        <ol className="proj4__listnum">
          <li>
            <strong>Empirical Calibration Matrix:</strong>
            <BlockMath math={"\\mathbf{C} = \\arg\\min_{\\mathbf{C}} \\sum_{i=1}^{N} \\left\\| \\mathbf{p}^{(i)}_{ground\\_truth} - \\mathbf{C} \\mathbf{p}^{(i)}_{measured} \\right\\|^2"} />
          </li>
          <li>
            <strong>Real-time Validation:</strong> Continuous comparison with known reference points
          </li>
          <li>
            <strong>Future Enhancement:</strong> PointCloud registration using Iterative Closest Point (ICP)
          </li>
        </ol>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          <strong>Problem:</strong> Excessive buffer zones causing navigation failures in narrow passages.
        </p>

        <p className="proj4__lead">Optimization Approach:</p>
        <BlockMath math={"J(b) = w_1 \\sum_i I^{(i)}_{collision} + w_2 \\sum_j T^{(j)}_{stuck} + w_3 \\sum_k D^{(k)}_{deviation}"} />
      ...
      <section className="proj4__section">
        ...
        <p className="proj4__lead">Benchmark Comparison with Existing Solutions:</p>
      ...
      <section className="proj4__section">
        ...
        <p className="proj4__lead">
          <strong>Planned Multi-Sensor Integration:</strong> 
          {" "}x̂<sub>fused</sub> = Σ<sub>i=1→n</sub> w<sub>i</sub>x̂<sub>i</sub>
        </p>
        <p>
          Where weights are optimized based on sensor reliability:{" "}
          <BlockMath math={"w_i = \\frac{\\sigma_i^{-2}}{\\sum_{j=1}^n \\sigma_j^{-2}}"} />
        </p>
        <p>
          <strong>Expected Performance Improvement:</strong> 
          {" "}σ<sub>fused</sub><sup>2</sup> = (Σ<sub>i=1→n</sub> σ<sub>i</sub><sup>-2</sup>)<sup>-1</sup> ≤ min σ<sub>i</sub><sup>2</sup>
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p className="proj4__lead">
          This research presents a comprehensive industrial safety robot system that successfully integrates
          multiple cutting-edge technologies to address critical workplace safety challenges. Through rigorous
        ...
        <ol className="proj4__bullets">
          <li>
            <strong>Real-time Multi-Modal Detection:</strong> Achieved 93% accuracy in hazard identification with sub-400ms response times
          </li>
          <li>
            <strong>Advanced Noise Filtering:</strong> Implemented Kalman filtering resulting in 24.7% noise reduction
          </li>
          <li>
            <strong>Robust Communication:</strong> Developed MQTT-based distributed communication with 99.8% reliability
          </li>
          <li>
            <strong>Intelligent Coordination:</strong> Created multi-robot coordination system with 96% task success rate
          </li>
        </ol>
      </section>
      ...
      <section className="proj4__section">
        ...
        <ul className="proj4__bullets">
          <li>Formalized risk assessment framework for industrial environments</li>
          <li>Proved theoretical superiority of 4D state tracking over 2D alternatives</li>
          <li>Developed optimization models for navigation parameter tuning</li>
        </ul>

        <h4 className="proj4__h4">System Engineering:</h4>
        <ul className="proj4__bullets">
          <li>Integrated heterogeneous technologies into cohesive safety monitoring system</li>
        ...
        <ul className="proj4__bullets">
          <li>Demonstrated practical applicability in simulated industrial environments</li>
          <li>Achieved performance metrics suitable for real-world deployment</li>
          <li>Established scalable foundation for future safety system development</li>
        </ul>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          This work represents a significant advancement in autonomous industrial safety systems, 
          providing both theoretical foundations and practical implementations. 
          The mathematical rigor combined with real-world testing demonstrates the system’s 
          readiness for industrial deployment while identifying clear pathways for continued improvement.
        </p>

        <p>
          <strong>Future Impact Projection:</strong> With proper scaling and industrial partnership, 
          this system has the potential to contribute to the reduction of industrial accidents, 
          directly supporting the goal of preventing workplace fatalities through intelligent, continuous monitoring.
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <blockquote className="proj4__quote">
          “The intersection of rigorous mathematics and compassionate engineering creates not just 
          efficient systems, but technologies that preserve human dignity and life itself. 
          In every equation solved and every algorithm optimized, we find the possibility of 
          someone returning home safely.”
        </blockquote>
      </section>
      ...
      <section className="proj4__section">
        ...
        <p>
          We extend our gratitude to the K-Digital Training program, our mentors, 
          and Doosan Robotics for providing the platform and resources necessary 
          for this research. Special thanks to all team members who contributed 
          their expertise across multiple technical domains.
        </p>
      </section>
      ...
      <section className="proj4__section">
        ...
        <ol className="proj4__references">
          <li>
            Ministry of Employment and Labor, “Industrial Accident Investigation Report 2024,” 
            Korea Occupational Safety and Health Agency
          </li>
          <li>
            Kalman, R.E., “A New Approach to Linear Filtering and Prediction Problems,” 
            <em>Journal of Basic Engineering</em>, vol. 82, no. 1, pp. 35-45, 1960
          </li>
          <li>
            Redmon, J., et al., “You Only Look Once: Unified, Real-Time Object Detection,” 
            <em>IEEE Conference on Computer Vision and Pattern Recognition</em>, 2016
          </li>
          <li>
            Ultralytics, “YOLOv8: A New State-of-the-Art Computer Vision Model,” 2023
          </li>
          <li>
          ...
          <li>
            ...
            <em>IEEE/RSJ International Conference on Intelligent Robots and Systems</em>, 2020
          </li>
          <li>
            Light, A., “MQTT Protocol Specification v3.1.1,” OASIS Standard, 2014
          </li>
          <li>
            Lee, M.J., “Promoting Sustainable Safety Work Environments: Factors Affecting Korean Workers’ Recognition,” 
